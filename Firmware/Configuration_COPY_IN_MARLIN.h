...
#define STRING_CONFIG_H_AUTHOR "(Benh, Mr.Ender-V4.1.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MR.Ender-v4.1.0"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -40, -2.5 }
