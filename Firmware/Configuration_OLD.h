...
#define STRING_CONFIG_H_AUTHOR "(Benh, Mr.EnderTURBO-V4.0.5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Turbo.Ender-v4.0.5"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 393.23 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -35, -1.5 }
