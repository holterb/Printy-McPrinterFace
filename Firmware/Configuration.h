...
#define STRING_CONFIG_H_AUTHOR "(Benh, Mr.EnderTURBO-V4.5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Turbo.Ender-v4.5"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -35 , -3.06 }
