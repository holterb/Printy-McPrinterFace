 ...
 */
  ...
  #define WATCH_BED_TEMP_INCREASE               42 // Degrees Celsius
#endif
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       625        // (mA) RMS current. Multiply by 1.414 for peak current.
