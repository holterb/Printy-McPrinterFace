...
// Look here: https://www.reddit.com/r/ender3/comments/h8y1ia/marlin_20x_guide_skr_mini_e3_v20_ender_3/ 
...
#define e__steps 393.23 //93*4.2283 //This is custom for my titanclone with pancake stepper  //e-steps is defined by the number of revolutions your extruder motor has to turn to define 10mm of filament.
#endif
...
#define Total_filament_path 100 // Please measure the entire distance fron the Extruder to the the tip of the nozzle as accurately as possible. Replace change_value with your measured value here in mm units. NOT ft/inch.
...
#define HOMING_MOVEMENT_SPEEDK 2 // Acceptable values are 1 (default), 2, 3, 4, 5 and 6. Please watch out for speeds 5 and 6. These changes your printer's XY homing AND LCD XY manual movement speed.
...
#endif
#define DEFAULT_EJERK    18.0  // May be used by Linear Advance. 
...
#define CUSTOM_MACHINE_NAME "MrEnder-1.3.0"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 100, 25 } //keep z at 8. otherwise your motor WILL SKIP
...
//#define DEFAULT_EJERK    18.0  // May be used by Linear Advance //value defined in section 14 of config.h
