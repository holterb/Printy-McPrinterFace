...
#define Total_filament_path 650// Please measure the entire distance fron the Extruder to the the tip of the nozzle as accurately as possible. Replace change_value with your measured value here in mm units. NOT ft/inch.
...
#define CUSTOM_MACHINE_NAME "MrEnder-1.1.1"
